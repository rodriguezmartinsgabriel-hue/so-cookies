...
describe("THead", () => {
  it("renders a <thead> element", () => {
    const { container } = renderTable(<THead><Tr><Th>Col</Th></Tr></THead>);
...
describe("TBody", () => {
  it("renders a <tbody> element with divide-y class", () => {
    const { container } = renderTable(<TBody><Tr><Td>cell</Td></Tr></TBody>);
...
describe("Tr", () => {
  it("renders a <tr> element with hover transition", () => {
    const { container } = renderTable(<TBody><Tr><Td>x</Td></Tr></TBody>);
...
describe("Th", () => {
  ...
  it("renders the cell content", () => {
    renderTable(<THead><Tr><Th>Name</Th></Tr></THead>);
...
describe("Td", () => {
  ...
  it("renders the cell content", () => {
    renderTable(<TBody><Tr><Td>Value</Td></Tr></TBody>);
